...
export default function NavigationBar() {
  ...
  return (
    ...
    >
      <div
        className={`flex flex-row items-center gap-2 p-1.5 rounded-full border transition-all duration-300 ${scrollY > 20
        ...
        {navItems.map((item) => {
          ...
          return (
            <Link
              key={item.path}
              href={item.path}
              className={`flex items-center gap-2 px-4 py-2 rounded-full font-medium transition-all duration-300 ${isActive
